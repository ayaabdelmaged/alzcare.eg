...
const AddPatient = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name.startsWith('family.')) {
      ...
      setFormData(prev => ({
        ...prev,
        family: { ...prev.family, [familyField]: value },
      }));
    } else {
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white/[0.03] rounded-2xl border border-white/[0.08] p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Patient Email */}
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Patient Email *</label>
              ...
              {/* Patient Password */}
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-2">Patient Password *</label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">
                    <LockIcon />
                  </div>
